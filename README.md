...
Execute o script: Certifique-se de ter o Python instalado no sistema e execute o arquivo principal:

bash
Copy code
python3 winy.py
Siga as instruções no terminal para usar as funcionalidades do sistema.
